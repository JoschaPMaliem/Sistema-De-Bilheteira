...
class Venda {
  ...
  @override
  String toString() {
    return 'Venda{id: $id, clienteId: $id_cliente, bilheteId: $id_bilhete, quantidade: $quantidade, valorTotal: $valorTotal, data: $dataDeVenda}';
  }
}
...
class VendaModel {
  ...
  Future<List<Venda>> getVendas() async {
   ...
   Future<List<Bilhete>> getBilhetesPorCliente(int clienteId) async {
    ...
    return result.map((json) => Bilhete(
      id: json['id'] as int,
